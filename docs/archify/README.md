# mousecrack Archify Architecture
...
- Repository URL: https://github.com/hundong2/mousecrack.git
- Checkout SHA: 39f59a16bec34b8bea0268b454998e7553ee932a
- README file: README_kor.md
- Evidence file: README_kor.md
- README title: 실제 cursor 이동
- Dependency markers:
- Top-level directories: .claude-plugin, .codex-plugin, assets, docs, guide, inference, skills
- Category: Evaluation, security, observability

## 적용 프롬프트

~~~~text
Use Archify to create a high-level architecture diagram for mousecrack.
...
주 경로는 `Developer / learner -> README and docs -> Setup and deps -> Entry points -> Eval / security core -> Reports / findings`이다.
